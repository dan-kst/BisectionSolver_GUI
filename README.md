...
* **Strategy Pattern**: Easily switch between Sequential, MPI Parallel, Threaded solvers at runtime.
...
### Sequential/Threaded Mode

You can launch the application directly for single/multi-threaded tasks:
```
./build/lab7_app
```
...
1. Verification:
  ...
  * Switch to **Multithreaded (jthread)** or **MPI Parallel** and run the same workload to calculate the speedup factor.
